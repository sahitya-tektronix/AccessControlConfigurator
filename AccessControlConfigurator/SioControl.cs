...

{
...

    {
        ...
        private EditControllerControl _parentEditControl;
        ...
        public SioControl(ControllerDto controller, EditControllerControl parentEditControl)

            : this(controller)

        {

            _parentEditControl = parentEditControl;
...

        {
...

            {
                ...
                // Keep the RS-485 grids as-is; only refresh the main SIO controller grid.

                _parentEditControl?.RefreshSiosAsync();
