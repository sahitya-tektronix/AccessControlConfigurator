...
{
    internal static class TimezoneErrorHelper
    {
        ...
        public static string GetMessage(string rawMessage)
        {
            ...
            return errorCode switch
            {
                ...
                "timezone_name_required" => "Name is required.",
                "built_in_timezone_cannot_be_modified" => "Existing Timezones cannot be modified.",
                "built_in_timezone_cannot_be_deleted" => "Existing Timezones cannot be deleted.",
                "timezone_not_found" => "Timezone not found.",
                "duplicate_timezone_name" => "A timezone with the same name already exists.",
